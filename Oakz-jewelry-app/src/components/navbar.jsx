...
import Oakz from '../../public/images/OAKZ.png'
    ...
    <div className='flex flex-row justify-between font-bienvenido items-center py-8 px-4'>
        ...
        <div>
            <div className="flex justify-center items-center gap-4">
                <div className=' py-[2px] h-[34px] flex flex-row gap-1 hover:cursor-text rounded-[50px] bg-transparent border-2 border-green focus-within:border-green focus-within:border-2 active:border-green items-center'>
                        ...
                        <div className='cursor-pointer bg-green m-[2px]  p-[2px] rounded-[50px] text-white' >
