...
function Navbar() {
  ...
  return (
    <div className='flex flex-row justify-between font-bienvenido items-center sm:py-8 sm:px-4 pt-2 pb-9 w-full '>
      {/* Block for larger screens -  */}
      <div className='hidden sm:w-full sm:flex flex-row sm:justify-between items-center gap-4'>
        <div>
